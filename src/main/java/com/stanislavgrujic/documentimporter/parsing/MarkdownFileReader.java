...
public class MarkdownFileReader {
  ...
  public void read() {
    ...
    resources.add(new ClassPathResource("markdown/Typical_enterprise_system_architecture.md"));
    resources.add(new ClassPathResource("markdown/Why_architecture.md"));
